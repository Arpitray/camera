  ...
  return (
    <div className='third-page bg-[#F3E4D3] px-6 md:px-12 lg:px-16 py-18 lg:py-0'>
     ...
     <div className="box2 flex flex-col md:flex-row justify-between w-full mt-12 md:mt-16 lg:mt-20 gap-6 md:gap-0">
          <div className="image2 w-full md:w-80 lg:w-112 h-52 md:h-64 lg:h-78 shadow-lg border-8 border-white -rotate-6 md:-rotate-12 overflow-hidden rounded-xl">
            <img src={Image2} alt="" className='w-full h-full object-cover rounded-xl' />
          </div>
                 <div className="image2 mt-8 md:mt-24 lg:mt-32 w-full md:w-84 lg:w-118 h-56 md:h-68 lg:h-85 shadow-lg border-8 border-white -rotate-3 md:-rotate-9 overflow-hidden rounded-2xl">
     ...
     <div className="box mt-32 md:mt-48 lg:mt-64 ml-0 md:ml-32 lg:ml-62">
               <div className="image2 mt-16 md:mt-24 lg:mt-32 w-full md:w-72 lg:w-92 h-48 md:h-60 lg:h-72 shadow-lg border-8 border-white rotate-12 md:rotate-18 overflow-hidden rounded-2xl">
