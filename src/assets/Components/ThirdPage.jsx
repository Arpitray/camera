...
function ThirdPage() {
  return (
    <div className='third-page bg-[#F3E4D3] px-6 md:px-12 lg:px-16 '>
      <h1 className='uppercase text-center w-full tracking-wider text-[80px] pt-12 lg:pt-0 md:text-[160px] lg:text-[250px] font-bold text-[#80320b] font-["bystander"]'>retroscope</h1>
